    ...
    <body>
        ...
        <main>
            ...
            <fieldset>
                ...
                $sql_select = "SELECT orders.Order_Date, user_details.username, order_items.Fruit_1, order_items.Fruit_2, 
                order_items.Nuts_Seeds_Spices, order_items.Quantity, order_items.Thickness, order_items.Extras 
                FROM order_items JOIN orders ON order_items.Order_ID = orders.Order_ID JOIN user_details ON orders.client_id = user_details.client_id;";
